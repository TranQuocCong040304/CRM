                                     ...
                                     <tbody>
									    <c:forEach var="user" items="${userList}">
									        <tr>
									            ...
									            <td>${user.role}</td>
									            <td>
									                <a href="edit-user.jsp?id=${user.id}" class="btn btn-sm btn-primary">Sửa</a>
									                <a href="delete-user?id=${user.id}" class="btn btn-sm btn-danger">Xóa</a>
									                <a href="user-details.jsp?id=${user.id}" class="btn btn-sm btn-info">Xem</a>
									            </td>
									        </tr>
									    </c:forEach>
									</tbody>
